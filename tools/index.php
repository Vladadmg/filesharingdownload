...
function _head()
{
	...
	idx.innerHTML='<div class="rounded gray" style="padding:5px 10px 5px 7px;color:#202020">' +
		'<p class="left">' +
			'<strong>File Sharing Downloads</strong><br />' + (_files.length+_dirs.length) + ' objects in this folder, ' + _s(_tsize) + ' total.' +
		'</p>' +
		'<p class="right">' +
...
_d('Peer_Guardian','Nov-12-05','index.php?dir=Peer_Guardian');
_d('P2P_Security_Tools','Dec-23-05','index.php?dir=P2P_Security_Tools');
_d('MP3_Shield','Jan-03-06','index.php?dir=MP3_Shield');
_f('DAMN_NFO_Viewer_v2.10.0031.RC3_Setup.exe',252928,'Jul-17-05','DAMN_NFO_Viewer_v2.10.0031.RC3_Setup.exe',1121602036);
_f('KazaaBegone.exe',338897,'Apr-01-05','KazaaBegone.exe',1112380490);
