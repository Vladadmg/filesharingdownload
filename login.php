...
<html><head>
<title>FileSharingDownloads - Login</title>
...
<br /><table class=lista cellpadding=0 cellspacing=0 width=95% align=center>
	<tr>
		<TD class=block align=center height=20px colspan=1><b>Login</b></TD>
	</tr>
	<tr>
		<TD width=100% align=justify valign=top><form method="post" action="login.php?returnto=index.php">
<table class="lista" border="0" cellpadding="10">
<tr><td align="right" class="header">User:</td><td class="lista"><input type="text" size="40" name="uid" value="" maxlength="40" /></td></tr>
<tr><td align="right" class="header">Password:</td><td class="lista"><input type="password" size="40" name="pwd" maxlength="40" /></td></tr>
<tr><td colspan="2"  class="header" align="center"><input type="submit" value="Confirm" /></td></tr>
<tr><td colspan="2"  class="header" align="center">Note: You need cookies enabled to log in.</td></tr>
</table>
</form>
<a href="account.php">Create account</a>&nbsp;&nbsp;&nbsp;<a href="recover.php">Recover password</a>
</center>
		</td>
	</tr>
	<tr>
